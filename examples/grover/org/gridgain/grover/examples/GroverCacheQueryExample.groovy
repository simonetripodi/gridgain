...
class GroverCacheQueryExample {
    ...
    private static void example(Grid g) {
        ...
        print("People with salary more than 1000: ", cache.sql(prj, Person.class, "salary > 1000").
            collect { t -> t._2 })

        // Example for TEXT-based querying for a given string in people resumes.
        // Gets all persons with 'Bachelor' degree.
        print("People with Bachelor degree: ", cache.lucene(prj, Person.class, "Bachelor").
            collect { t -> t._2 })
